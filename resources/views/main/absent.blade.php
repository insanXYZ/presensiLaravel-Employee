...
<div class="w-full relative flex flex-col items-center">
    ...
    <div class="my-24 w-2/4 max-w-5xl min-w-fit gap-8 flex flex-col items-center">
        <form action="/absent" method="POST" class="flex flex-col items-center gap-8">
            @csrf
            <div id="cameraZone">
                <div id="camera"></div>
                <input type="button" class="w-full py-2 rounded-md text-white bg-biru cursor-pointer" value="Take picture" onclick="take_snapshot()">
                <input type="hidden" name="image" id="image_tag">
                <input type="hidden" name="location" id="location_input">
            </div>
            <div id="resultZone" class="hidden flex flex-col gap-8">
                <div id="results"></div>
